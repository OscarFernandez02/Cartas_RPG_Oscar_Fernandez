...
<h1 class="titol">Visualitzar cartes</h1>
 <ul class="breadcrumb">
  <li><a href="principal.jsp">Inici</a></li>
...
//creamos la consulta
num_reg = num_registres.executeQuery("SELECT * FROM cartaRPG");
...
try{
	...
	//inmediatamente hacemos una consulta sencilla
	//creamos la consulta
	String sentence="SELECT * from cartaRPG limit "+inicio+","+TAMANO_PAGINA;
	...
	<br>
	race:<%out.print(rs.getString("clase")); %><br>
	...
	<table width="<%out.print(rs.getString("vida")); %>" bgcolor="magenta"><tr><td></td></tr></table>
	PM:<%out.print(rs.getString("mana")); %><br>
	<table width="<%out.print(rs.getString("mana")); %>" bgcolor="cian"><tr><td></td></tr></table>
	<br>
	<img src="img/<%out.print(rs.getString("foto")); %>.png" height="100" width="80">
	<br>
<% 
	}
